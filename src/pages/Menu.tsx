...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { he: 'שרשרת תהלים', es: 'Cadenas de Tehilim', desc: 'Organiza o súmate: entre todos se completan los 150 capítulos por un motivo.', to: '/retos?t=tehilim' },
      { he: 'מדריך אתגרים', es: 'Cómo usar Retos', desc: 'Privacidad, cómo invitar y cómo funciona ver los nombres solo si ambos aceptan.', to: '/retos/guia' },
