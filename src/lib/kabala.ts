...
export const KABALA_PRESETS: KabalaPreset[] = [
  ...
  },
  {
    ...
    for: 'mujer',
    kind: 'hacer',
    es: 'Orar cada día por mis hijos',
    he: 'תְּפִלָּה עַל הַיְלָדִים',
    blurb:
      'Una oración diaria por tus hijos, o por los hijos que esperas. Sará, Rivká, Rajel y Jana rezaron por hijos: su fe nos sostiene todavía. No estás sola en esa espera.',
    days: 40,
    area: 'tefillah',
    kavana: 'Que mis hijos, los que tengo y los que espero, crezcan cerca de Hashem.',
  },
  {
    id: 'tefila-zivug',
    for: 'mujer',
    kind: 'hacer',
    es: 'Orar cada día por mi zivug',
    he: 'תְּפִלָּה עַל זִוּוּג',
    blurb:
    ...
    days: 40,
    area: 'tefillah',
    kavana: 'Que Hashem me acerque a mi zivug en el momento justo, y que me encuentre lista.',
  },
  {
    id: 'hablar-con-hashem',
    for: 'mujer',
    kind: 'hacer',
    es: 'Hablar con Hashem con mis palabras',
    he: 'תְּפִלָּה מֵהַלֵּב',
    blurb:
      'Cinco minutos al día, con tus propias palabras: agradecer, pedir, desahogarte. Jana (Ana) es el modelo de la oración que sale del corazón.',
    days: 30,
    area: 'tefillah',
    kavana: 'Hablar con Hashem como se habla con un Padre que escucha.',
  },
  {
    id: 'shalom-bayit-diario',
    for: 'mujer',
    kind: 'hacer',
    es: 'Un gesto diario por la paz del hogar',
    he: 'שְׁלוֹם בַּיִת',
    blurb: 'Una palabra buena, un cariño, una espera: un gesto concreto cada día por la paz de tu casa.',
    days: 30,
    area: 'ben_adam',
    kavana: 'Que mi casa sea un lugar de paz, y que yo la edifique con sabiduría.',
  },
  {
    id: 'halajot-mujer',
    for: 'mujer',
    kind: 'hacer',
    es: 'Diez minutos de halajot al día',
    he: 'לִמּוּד הֲלָכוֹת',
    blurb:
      'Estudiar cada día, aunque sean diez minutos, las halajot que usas en tu vida: Shabat, kashrut, berajot, taharat hamishpajá. Poco cada día, pero todos los días.',
    days: 30,
    area: 'torah',
    kavana: 'Conocer lo que Hashem me pide, para cumplirlo con alegría.',
  },
  {
    id: 'cuidar-tzniut',
    for: 'mujer',
    ...
    he: 'צְנִיעוּת',
    blurb:
      'Tzniut en la ropa, la conducta y el habla. No es esconderse: es saber cuánto vales. Cada día que la cuidas, cuenta; y si caes, lo que sigue es el regreso.',
    days: 30,
    area: 'kedushah',
